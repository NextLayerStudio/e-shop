      ...
      <div className="mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-2 lg:gap-14">
        <div className="text-center lg:text-left">
          ...
          <p className="mx-auto mt-5 max-w-xl text-pretty leading-relaxed text-white/85 lg:mx-0">
            Máš konkrétny nápad, ale nevieš kde ho nechať vytlačiť? Pošli nám
            súbor alebo len popiš čo potrebuješ — cenu a termín dohodneš s nami
            priamo. Tlačíme zo všetkých bežných materiálov, viac sa dozvieš vo
            formulári nižšie.
          </p>
          <Link
            href="#tlac-form"
